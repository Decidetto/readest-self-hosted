...
> [!IMPORTANT]
> This downstream repository publishes clients for user-operated Readest servers. See the [self-hosted client documentation](docs/selfhost-builds.md) for downloads, configuration, builds, and release maintenance.
