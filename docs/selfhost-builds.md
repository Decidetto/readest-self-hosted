...
More details: [Client self-host configuration](./selfhost-client.md).
...
After deployment, expose the public runtime config endpoint documented in [docs/selfhost-client.md](./selfhost-client.md), then enter your public server URL in the client.
